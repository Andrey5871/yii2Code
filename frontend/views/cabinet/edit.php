...
<form>
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name" length="255" id="manufacturName" placeholder="Введите имя" value="<?=$client['name']?>" autocomplete="off">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="surName" length="255" id="manufacturSurname" placeholder="Введите фамилию" value="<?=$client['surname']?>" autocomplete="off">
    <div class="invalid-feedback">
        Вы не ввели фамилию!
      </div>
  </div>
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="patronymic" length="255" id="manufacturPatronymic" placeholder="Введите отчество" value="<?=$client['patronymic']?>" autocomplete="off">
     <div class="invalid-feedback">
      ...
      <div class="row">
          <div class="col">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="date" id="manufacturBrithDay" placeholder="Укажите дату рождения" value="<?=date("d.m.Y", strtotime($client['brithDay'])) ?>">
  ...
  <div class="form-group" style="position:relative">
    ...
    <input type="text" class="form-control" name="city" id="manufacturCity" placeholder="Название города" idcity="<?=$client['cityId']?>" autocomplete="off" value="<?=$city['name']?>" >
    <!-- BEGINVIEWCITY -->
  ...
  <div class="form-group" style="position:relative">
    ...
    <input type="text" class="form-control" name="educationName" id="manufacturEducation" placeholder="Название ВУЗа" autocomplete="off" ideducation="<?=$client['nameEducationId']?>" value="<?=$education['name']?>">
    <!-- BEGINVIEWeducation -->
  ...
  <div class="row">
        <div class="col-11 col-md">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="educationLevel" length="2" id="manufacturEducationLevel" value="<?=$client['educationLevel']?>" placeholder="Укажите курс" autocomplete="off">
            <div class="invalid-feedback">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" id="manufacturEmail" length="30" type="email" aria-describedby="emailHelp" placeholder="Введите email" autocomplete="off" value="<?=$client['email']?>">
    <div class="invalid-feedback">
        Вы не ввели email!
      </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="manufacturPhone" length="32" type="phone" aria placeholder="Введите телефон" autocomplete="off" value="<?=$client['phone']?>">
    <div class="invalid-feedback">
              ...
              if ($(el).val() == "") {
                ...
                $("form #manufacturBrithDay").next(".invalid-feedback").text("Ошибка, укажите дату рождения!");
                  ...
                  actionError.push("education");
                    ...
                    $.ajax({
                            url: '<?=Url::to(['cabinet/edit', 'update'=>'update'])?>',
                            type: 'POST',
                            data: {"_csrf-frontend": '<?=Yii::$app->request->getCsrfToken()?>', id:id, name:name, surName:surName, patronymic:patronymic, brithDay:brithDay, gender:gender, idCity:idCity, idEducation:idEducation, levelEducation:levelEducation, typeEducation:typeEducation, password:password, email:email, phone:phone, idUsers:idUsers},
                            beforeSend: function(){
