...
<div class="row">
  <div class="col">
    <div class="form-group dates">
      ...
      <input type="text" class="form-control" name="date" id="manufacturBrithDay" placeholder="Укажите дату рождения" value="<?=date("d.m.Y", strtotime($user['brithDay'])) ?>">
...
<div class="form-group" style="position:relative">
  ...
  <input type="text" class="form-control" name="city" id="manufacturCity" placeholder="Название города" idcity="<?=$user['cityId']?>" autocomplete="off" value="<?=$city['name']?>" >
  <!-- BEGINVIEWCITY -->
...
<div class="form-group" style="position:relative">
  ...
  <input type="text" class="form-control" name="educationName" id="manufacturEducation" placeholder="Название ВУЗа" autocomplete="off" ideducation="<?=$user['nameEducationId']?>" value="<?=$education['name']?>">
  <!-- BEGINVIEWeducation -->
  ...
  <div class="row">
    <div class="col-11 col-md">
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="educationLevel" length="2" id="manufacturEducationLevel" placeholder="Укажите курс" autocomplete="off" value="<?=$user['educationLevel']?>">
        <div class="invalid-feedback">
  ...
  <div class="row">
    <div class="col-11 col-md">
      <div class="form-group">
        ...
        <input type="password" class="form-control" name="password" length="255" id="manufacturPassword" placeholder="Придумайте пароль" autocomplete="off" value="<?=$psw?>">
        <div class="invalid-feedback">
              ...
              if ($(el).val() == "") {
                ...
                $("form #manufacturBrithDay").next(".invalid-feedback").text("Ошибка, укажите дату рождения!");
                  ...
                  actionError.push("education");
                    ...
                    $.ajax({
                            url: '<?=Url::to(['cabinet/editprofile', 'update'=>'update'])?>',
                            type: 'POST',
