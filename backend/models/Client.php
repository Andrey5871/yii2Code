...
class Client extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'surname', 'patronymic', 'brithDay', 'gender', 'cityId', 'nameEducationId', 'educationLevel', 'educationTypeId', 'phone', 'createTime', 'updateTime', 'statusId', 'sumOrder', 'sumUsers'], 'required'],
