...
<form>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="name" length="100" id="manufacturName" placeholder="Введите заголовок" value="<?=$news['title']?>" autocomplete="off">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="surName" length="255" id="manufacturSurname" placeholder="Введите краткое описание" value="<?=$news['minDesc']?>" autocomplete="off">
    <div class="invalid-feedback">
  ...
  <div class="form-group">
   <label id="fullDesc"></label>
    <textarea type="text" class="form-control" name="patronymic" length="1024" id="manufacturPatronymic" placeholder="Введите полное описание" autocomplete="off"><?=$news['description']?></textarea>
     <div class="invalid-feedback">
  ...
  <div class="result text-center" style="max-width:500px; max-height: 500px; overflow:hidden">
    <?php if ($news['img'] != ""): ?>
      <div class="row">
        <div class="col-12">
            <img src='/common/img/<?=$news['img']?>' style="max-width:500px; max-height: 500px;" alt="">
        </div>
      </div>
              ...
              if ($(el).val() == "") {
                var textInput = $(el).attr('placeholder');
                  ...
                  actionError.push("length");
                    ...
                    $.ajax({
                            url: '<?=Url::to(['site/editnews', 'update'=>'update'])?>',
                            type: 'POST',
                            data: formData,
                            processData: false,
                            contentType: false,
